# -*- coding: utf-8 -*-
"""
Created on Sat Dec  6 14:34:45 2025

From the data obtained from DANTE.py we construct the mass radius relation for a neutron star
...
# Save plot as PDF
plt.tight_layout()
plt.savefig("figures\MR_curves_NS.svg", format="svg", bbox_inches="tight")
